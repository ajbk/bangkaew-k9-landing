...
export const IconContainer = ({
  ...
  return (
    ...
    >
      <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-700 bg-slate-900/90 shadow-inner shadow-sky-950/40">
        {icon || (
      ...
      <div className="hidden rounded-md px-2 py-1 md:block">
        <div className="text-center text-xs font-bold text-slate-400">{text || "Threat signal"}</div>
      </div>
    </motion.div>
  );
};
